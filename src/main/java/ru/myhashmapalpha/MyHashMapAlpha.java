...
/**
 * Альфа версия собственной реализации Map.
 * Новый элемент записывает в следующую "свободную ячейку" массива. В массив "рядом" кладется хэшкод этокго ключа под таким же индексом.
 * Поиск ключа происходит с помощью простого перебора всех элементов массива по хэшкоду
 * отсутствует механизм авторасширения и копирования массива
 * отсутствует механизм обработки коллизий хэшкода
 * @param <K>
 * @param <V>
 */
